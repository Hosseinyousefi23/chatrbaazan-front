...
export class ConventionComponent implements OnInit {
  ...
  searchoffer(){
    this.offer.search(null,null,null,'favorites',this.cityHeader,'5',null,'3').subscribe((data :any) => {this.mostseen = data['results'];if(data['results'][0]){this.showDiv =true}; this.addeventlister();});
